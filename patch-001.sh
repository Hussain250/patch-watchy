...
wget "https://github.com/benlycos/patch-watchy/raw/main/bond007-ui.tar.gz" -O "${TEMP_DIR}/bond007-ui.tar.gz"
sudo tar -xvf  "${TEMP_DIR}/bond007-ui.tar.gz" -C /opt/watchy/
sudo wget "https://github.com/benlycos/patch-watchy/raw/main/maxwell.cfg" -O "/opt/watchy/bond007-core/conf/maxwell.cfg"
